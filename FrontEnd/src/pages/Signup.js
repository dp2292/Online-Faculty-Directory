...
// To display universities in dropdown
  ...
  const handleIsvalid=(password)=>{
    ...
    var passw=  /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z0-9])(?=.*[!@#$%^&*]).{8,32}$/;
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  error={!isvalid}
                  helperText={!isvalid ? "Password should contain at least one digit, one lowercase, one uppercase, and one special character, and length should be between 8 and 32" : ""}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
              ...
              <FormControl>
                ...
                >
                    ...
                    <FormControlLabel value="faculty" control={<Radio required={true}/>} label="Faculty" />
                </RadioGroup>
                </FormControl>
              </Grid>
            </Grid>
